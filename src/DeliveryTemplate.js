...
const DeliveryTemplate = ({
  ...
  <path d="M18 4l-4 4h3v7c0 1.1-.9 2-2 2s-2-.9-2-2V8c0-2.2-1.8-4-4-4S5 5.8 5 8v7H2l4 4 4-4H7V8c0-1.1.9-2 2-2s2 .9 2 2v7c0 2.2 1.8 4 4 4s4-1.8 4-4V8h3l-4-4z"/>
</svg>
        <Typography sx={{ 
          fontSize: '7pt', 
          fontWeight: 'bold', 
      ...
      <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 0.5 }}>
        <Typography sx={{ fontSize: '6.5pt', lineHeight: '1.1' }}>
          <strong>Delivery Challan No:</strong> {invoiceNumber}
        </Typography>
        <Typography sx={{ fontSize: '6.5pt', lineHeight: '1.1' }}>
          <strong>Date:</strong> {formattedDate}
        </Typography>
